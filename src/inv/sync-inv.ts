...
// Defaults to HIVE:WMS so the pull works without extra env config; the Deposco facility number
// is NOT a valid BC Location Code, so this map is required. Override via INV_LOCATION_MAP to
// retarget (e.g. HIVE:WESTERLY) without a code change.
